  ...
  return (
    <div className="w-full h-24 sticky top-0 z-50 bg-bodyColor mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600">
      ...
      <div>
        ...
        {showMenu && (
          <div
            className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900
            p-4 scrollbar-hide"
          >
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">
                  ...
                  Tempora magni quam quasi nihil ipsam voluptatibus iste officia
                  omnis saepe odio? Pariatur quam, id tempore minima a rem vitae
                  expedita ipsa.
                </p>
              </div>
